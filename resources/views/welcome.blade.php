...
<html lang="en">
    <head>
        <meta charset="utf-8">
            <meta content="width=device-width, initial-scale=1, shrink-to-fit=no" name="viewport">
                <meta content="Blog made in Laravel PHP framework" name="description">
                    <meta content="Boris Krnjajic" name="author">
                        <meta content="HTML,CSS,XML,JavaScript,PHP,Laravel,Blog,Programming" name="keywords">
                            <meta charset="utf-8">
                                <link href="../../favicon.ico" rel="icon">
                                    <title>Blog for PHP developers</title>
                                    {{-- JQuery  --}}
    ...
    @include('layouts.title')
        <div class="container">
            <div class="row">
                <div id="main-blog" class="col-sm-8 blog-main">
                    @yield('blogcontent')
                </div>
                <!-- /.blog-main -->
