...
<head>
    <title>Curriculum Vitae - Krnjajic Boris</title>
    <!-- Meta -->
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Curriculum Vitae - Krnjajic Boris">
    ...
    <!-- Theme CSS -->  
    <link id="theme-style" rel="stylesheet" href="/css/cv-styles.css">
...
<body>
    <div class="wrapper">
        <div class="sidebar-wrapper">
            <div class="profile-container">
                ...
                <h1 class="name">Boris Krnjajić</h1>
                <h3 class="tagline">Software Engineer</h3>
            </div><!--//profile-container-->
            
            <div class="contact-container container-block">
                <ul class="list-unstyled contact-list">
                    <li class="email"><i class="fa fa-envelope"></i><a href="mailto: yourname@email.com">krnjajic@hotmail.com</a></li>
                    <li class="phone"><i class="fa fa-phone"></i><a href="tel:00381643844165">+381643844165</a></li>
                    <li class="website"><i class="fa fa-globe"></i><a href="http://blog.dkwebpro.com/" target="_blank">Blog example</a></li>
                    <li class="linkedin"><i class="fa fa-linkedin"></i><a href="https://www.linkedin.com/in/boris-krnjajic-93277a64/" target="_blank">linkedin.com/boris-krnjajic</a></li>
            ...
            <div class="education-container container-block">
                ...
                <div class="item">
                    <h4 class="degree"><a href="http://www.ftn.uns.ac.rs/1244146535/faculty-of-technical-sciences" target="_blank">BSc in Mehatronics</a></h4>
                    <h5 class="meta"><a href="http://www.ftn.uns.ac.rs/1612271290/mechatronics" target="_blank">Faculty of Technical Science</a></h5>
            ...
            <div class="languages-container container-block">
                ...
                <ul class="list-unstyled interests-list">
                    <li>Serbian <span class="lang-desc">(Native)</span></li>
            ...
            <div class="interests-container container-block">
                ...
                <ul class="list-unstyled interests-list">
                    <li>Swimming</li>
                    <li><a href="https://en.wikipedia.org/wiki/Airsoft" target="_blank">Airsoft</a></li>
                </ul>
            </div><!--//interests-->
    ...
    <!-- Javascript -->          
    {{-- <script type="text/javascript" src="cv/assets/plugins/jquery-1.11.3.min.js"></script> --}}
    <script src="https://code.jquery.com/jquery-2.1.3.min.js"></script>
    <link crossorigin="anonymous" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css" integrity="sha384-BVYiiSIFeK1dGmJRAkycuHAHRg32OmUcww7on3RYdg4Va+PmSTsz/K68vbdEjh4u" rel="stylesheet">  
    <!-- custom js -->
    <script type="text/javascript" src="/js/cv-main.js"></script>            
</body>
</html> 
